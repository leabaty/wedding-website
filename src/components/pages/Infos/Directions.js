      ...
      <article className="container__full">
        <div className="page">
          ...
          <p className="text">
            ...
            village de Choue accueille notre mariage ! Pas trop loin pour que
            vous soyez en pleine forme en arrivant, et pas trop près pour que
            vous ne retourniez pas trop vite à vos vies chargées.😉
          </p>

          <p className="text">
            Pour maximiser la fiesta, on a réservé un taxi qui vous ramènera
            dans vos lits tout en douceur*!
          </p>
          <span className="text text--astx">*Douceur du taxi non contractuelle</span>

          <h2 className="undertitle">En voiture Simone !</h2>
          <p className="text bold"> 🚗 171 Alleray, 41170 Choue</p>
          <a
            target="_blank"
