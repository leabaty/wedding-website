  ...
  return (
    <>
      <article className="container__image">
        ...
        <img className="home2__img--couple" src={AlexAna} alt="Alex et Ana" />
        <img className="home2__img--mandala" src={Mandala} alt="Alex et Ana" />

        <article className="home2__quote">
          <p className="text">
          ...
          <p className="text home2__date">
            Le <span className="home2__emphasis">1er juillet 2023</span>, nous
          ...
          <div className="home2__cta">
            <a
              ...
              className="btn btn--outlined btn--large a home2__cta-link"
            >
              RSVP
            </a>
            ...
            <a
              ...
              className="btn btn--outlined btn--nano a home2__cta-link"
            >
