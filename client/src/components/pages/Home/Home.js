    ...
    <>
      <section className="container__image--landing">
        <div className="home__container">
          ...
          <article className="home__quote--mobile">
            ...
            <div className="home__buttons">
              <a
                ...
                className="btn btn--outlined btn--large a home__buttons-link"
              >
                RSVP
              </a>
              ...
              <a
                ...
                className="btn btn--outlined btn--nano a home__buttons-link"
              >
          ...
          <article className="home__quote--desktop">
            ...
            <p className="text">
              ...
              permanent besoin de célébrations collectives. Autour d’une
              bouteille de vin ou d’un thermos de tchai, assis par terre les uns
              sur les autres ou debout en dansant sur les chaises, nous ne
              vivons que pour le plaisir des moments partagés avec nos amis et
              famille, c’est-à-dire vous.
            </p>
